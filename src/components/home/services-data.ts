export interface Service {
  name: string
  slug: string
  // Card teaser copy. Wrap the punchiest phrase in **double asterisks** —
  // ServiceCard renders that span bold so the teaser has a scannable hook
  // pointing at the Solutions page, instead of reading as one flat line.
  description: string
}
